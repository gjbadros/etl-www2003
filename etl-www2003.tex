...
\end{listing}%$
\caption{PHP templates have minimal programming language construct
requirements.  Unfortunately, over the evolution of the presentation
layer, PHP developers sometimes engage in far broader interactions
because the power of the language allows them to do so.
\label{fig-php-books}}
\end{figure}
...
metamorphic syntax macros \cite{Brabrand2002}
