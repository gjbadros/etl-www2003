...
and template selection is analogous to method dispatch in
...
With regard to looping, only data-driven loops are supported.  Because
only finite data structures exist, this ensures that loops terminate.
...
output document for each request.  While typical templating languages
